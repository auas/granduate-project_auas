...
## get char embeddings
word2id = read_dictionary(os.path.join('.', args.train_data, 'new_word2id.pkl'))
...
if args.mode != 'demo':
    print("loading data")
    train_data,test_data = auas_read_corpus("/home/jins/wiki_model/data/extraction.corpus_all.json")
